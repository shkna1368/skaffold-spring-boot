package com.shabab.spkbskf.exceptions;
...
/*        List list2 = ex.getConstraintViolations().stream()

                .collect(Collectors.toList());*/

           List list2 =ex.getConstraintViolations().stream().collect(Collectors.toList());
